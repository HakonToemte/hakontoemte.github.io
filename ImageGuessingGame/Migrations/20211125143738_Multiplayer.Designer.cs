...
namespace ImageGuessingGame.Migrations
{
    ...
    [Migration("20211125143738_Multiplayer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.Game", b =>
                {
                    ...
                    b.Property<int?>("GuesserId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("IncorrectCount")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("MultiplayerOpenLobby")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.IndexSuggestion", b =>
                {
                    b.Property<int>("IndexSuggestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("IndexSuggestionId");

                    b.HasIndex("SuggestionId");

                    b.ToTable("IndexSuggestion");
                });

            modelBuilder.Entity("ImageGuessingGame.GameContext.MultiPlayerGuess", b =>
                {
                    b.Property<int>("MultiPlayerGuessId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("MultiPlayerGuessId");

                    b.HasIndex("OracleId");

                    b.ToTable("MultiPlayerGuess");
                });
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.Suggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.Game", b =>
                {
                    b.HasOne("ImageGuessingGame.GameContext.Guesser", "Guesser")
                        .WithMany()
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.IndexSuggestion", b =>
                {
                    b.HasOne("ImageGuessingGame.GameContext.Suggestion", "Suggestion")
                        .WithMany("IndexList")
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.Game", b =>
                {
                    ...
                    b.Navigation("MultiplayerGuessers");
            ...
            modelBuilder.Entity("ImageGuessingGame.GameContext.Oracle", b =>
                {
                    b.Navigation("MultiplayerGuesses");
